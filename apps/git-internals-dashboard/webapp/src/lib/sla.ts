...
// sx-prop style bundles for badges/dots.
export const SLA_BADGE_SX: Record<SlaState, { borderColor: string; backgroundColor: string; color: string }> = {
  NO_SLA: {
    borderColor: "color-mix(in srgb, var(--sla-no-sla) 30%, transparent)",
    backgroundColor: "color-mix(in srgb, var(--sla-no-sla) 10%, transparent)",
    color: "var(--sla-no-sla)",
  },
  OK: {
    borderColor: "color-mix(in srgb, var(--sla-ok) 30%, transparent)",
    backgroundColor: "color-mix(in srgb, var(--sla-ok) 10%, transparent)",
    color: "var(--sla-ok)",
  },
  AT_RISK: {
    borderColor: "color-mix(in srgb, var(--sla-at-risk) 30%, transparent)",
    backgroundColor: "color-mix(in srgb, var(--sla-at-risk) 10%, transparent)",
    color: "var(--sla-at-risk)",
  },
  VIOLATED: {
    borderColor: "color-mix(in srgb, var(--sla-violated) 30%, transparent)",
    backgroundColor: "color-mix(in srgb, var(--sla-violated) 10%, transparent)",
    color: "var(--sla-violated)",
  },
  TERMINAL: {
    borderColor: "color-mix(in srgb, var(--sla-terminal) 30%, transparent)",
    backgroundColor: "color-mix(in srgb, var(--sla-terminal) 10%, transparent)",
    color: "var(--sla-terminal)",
  },
};
