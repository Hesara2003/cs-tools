...
function StatCell({ label, value, color, hoverBorder, onClick }: StatCellProps) {
  return (
    <Box
      ...
      sx={{
        borderRadius: "9px",
        border: "1px solid var(--sla-border-soft)",
  ...
  return (
    ...
    >
        ...
        {focused ? (
          <Box
            ...
            sx={{
              flexShrink: 0,
              borderRadius: "6px",
              bgcolor: "color-mix(in srgb, var(--sla-primary) 14%, transparent)",
              px: 1,
              py: 0.5,
              fontSize: 10,
              fontWeight: 600,
      ...
      <Box sx={{ mt: 1.5, display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid var(--sla-border-soft)", px: 0.125, py: 1.5 }}>
        ...
        >
          Open tracked{" "}
          <Box component="b" sx={{ fontWeight: 600, color: "var(--sla-fg)", fontFamily: MONO }}>
            {project.openTracked}
          </Box>
        </Box>
        <Box
        ...
        >
          ...
          Untracked{" "}
          <Box component="b" sx={{ fontWeight: 600, color: "var(--sla-fg2)", fontFamily: MONO }}>
            {project.untracked}
          </Box>
        </Box>
      </Box>
