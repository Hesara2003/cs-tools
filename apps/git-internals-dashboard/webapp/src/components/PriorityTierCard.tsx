...
// Port of v3's src/components/PriorityTierCard.tsx.
import type { MouseEvent } from "react";
import { Box } from "@mui/material";
import type { OverviewPriority } from "@api/types";
  ...
  return (
    <Box
      sx={{
        ...
        border: `1px solid ${focused ? accent : "var(--sla-border)"}`,
        borderTopWidth: 4,
        ...
        <Box>
          <Box
            ...
            sx={{
              ...
              fontSize: 44,
              fontWeight: 600,
              color: tier.violated > 0 ? "var(--sla-violated)" : "var(--sla-ok)",
              background: "none",
              border: "none",
              cursor: "pointer",
              p: 0,
        ...
        <Box>
          <Box
            ...
            sx={{
              ...
              fontSize: 26,
              fontWeight: 600,
              color: tier.atRisk > 0 ? "var(--sla-at-risk)" : "var(--sla-no-sla)",
              background: "none",
              border: "none",
              cursor: "pointer",
              p: 0,
