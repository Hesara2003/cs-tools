...
// exists here — the producer side lives in entity-service's
// EventPublisherService, shared by every backend that calls it (csm-portal
// and customer-portal alike). Package choice and config shape deliberately
// mirror the sibling csm-portal-activity-stream-service's eventbus so the
